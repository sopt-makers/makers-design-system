...
interface IconUsersXProps extends HTMLAttributes<SVGSVGElement> {}

const IconUsersX = forwardRef<SVGSVGElement, IconUsersXProps>((props, ref) => {
  return (
    <svg
      {...props}
      ref={ref}
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1062_547"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
