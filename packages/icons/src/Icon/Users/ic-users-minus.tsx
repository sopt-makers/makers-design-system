...
interface IconUsersMinusProps extends HTMLAttributes<SVGSVGElement> {}

const IconUsersMinus = forwardRef<SVGSVGElement, IconUsersMinusProps>(
  (props, ref) => {
    return (
      <svg
        {...props}
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_1062_548"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_1062_548"
              result="shape"
            />
          </filter>
        </defs>
