...
interface IconMentoProps extends HTMLAttributes<SVGSVGElement> {}

const IconMento = forwardRef<SVGSVGElement, IconMentoProps>((props, ref) => {
  return (
    <svg
      {...props}
      ref={ref}
